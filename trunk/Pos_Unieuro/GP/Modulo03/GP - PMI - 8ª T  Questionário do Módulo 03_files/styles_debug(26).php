...
.path-mod-workshop .userplan tr.phasetasks li {
    background-image: url(image.php?theme=aardvark&image=userplan%2Ftask-todo&component=mod_workshop);
...
.path-mod-workshop .userplan tr.phasetasks li.completed {
    background-image: url(image.php?theme=aardvark&image=userplan%2Ftask-done&component=mod_workshop);
}

.path-mod-workshop .userplan tr.phasetasks li.fail {
    background-image: url(image.php?theme=aardvark&image=userplan%2Ftask-fail&component=mod_workshop);
}

.path-mod-workshop .userplan tr.phasetasks li.info {
    background-image: url(image.php?theme=aardvark&image=userplan%2Ftask-info&component=mod_workshop);
}
