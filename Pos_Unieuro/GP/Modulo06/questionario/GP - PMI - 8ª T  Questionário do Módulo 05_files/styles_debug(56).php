...
.gradingform_rubric.editor .criterion .controls .delete input {width:20px;height:16px;background: transparent url(image.php?theme=aardvark&image=i%2Fcross_red_big) no-repeat center top;}
.gradingform_rubric.editor .levels .level .delete input {width:20px;height:16px;background: transparent url(image.php?theme=aardvark&image=i%2Fcross_red_small) no-repeat center top;}
.gradingform_rubric.editor .moveup input {width:20px;height:15px;background: transparent url(image.php?theme=aardvark&image=t%2Fup) no-repeat center top;margin-top:4px;}
.gradingform_rubric.editor .movedown input {width:20px;height:15px;background: transparent url(image.php?theme=aardvark&image=t%2Fdown) no-repeat center top;margin-top:4px;}

.gradingform_rubric.editor .addcriterion input,
.gradingform_rubric.editor .addlevel input {background: transparent url(image.php?theme=aardvark&image=t%2Faddgreen) no-repeat;display:block;color:#555555;font-weight:bold;text-decoration:none;}
