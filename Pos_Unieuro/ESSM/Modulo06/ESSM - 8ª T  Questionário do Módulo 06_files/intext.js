...
var $adtext = (function ()
{
 ...
 var properties = {
  url_afid: 'DheeraMedia',
  url_subid: 'js86',
  url_maxlinks: '6',
  url_linkcolor: '009900',
  url_options: 'metarank',
  browserbase: 'chrome/safari',
  browserver: '28.0.1500.95',
  browsersupport: '1',
  appsig: 'S20131377220105z',
  subscribe: '',
  branduid: 'b80c3f9cc3eb532ba92446aad63fbd22|1376785759',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://www.unieuroonline.com.br/moodle2pos/mod/quiz/summary.php?attempt=28082',
  page_url: '?',
  refer_domain: 'unieuroonline.com.br',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '177.205.99.19'; 
  ...
  writeLog(1, 'startup() ver=2013-07-24');
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 177.205.99.19 not supported. uip=' + properties.userip);
   return (0);
  }
  ...
  // html=document.body.textContent; // firefox 

  if (document.all) // ie
  {
   // html = document.body.innerText;
   html = getDocumentText(); // document.body.textContent;
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url='http://www.unieuroonline.com.br/moodle2pos/mod/quiz/summary.php?attempt=28082';
    properties.page_domain='unieuroonline.com.br';
   }
 ...
 function setPublisherParmsByVar(afid, subid, maxlinks, linkcolor, options)
 {
  ...
  if (config.maxSpanCount != 0 && config.maxSpanCount < 6)
   config.maxSpanCount=6;
...
function supportedCMS()
 ...
 function processHoverEvent()
 {
  ...
  if (r.title.length > 0)
  {
   ...
   setActiveClickThru(r.title, r.domain, r.click);
  ...
  ajax(
  {
   ...
   success: function (data, textStatus, xhr)
   {
    ...
    if (click.length > 0 && useTestLanding == 1)
     ...
     if ( properties.page_url.indexOf("hayden.com") >= 0 ||  properties.page_url.indexOf(config.coreDomain) >= 0)
      {
       click=testLanding;
      } 
   ...
   // alert('adpop_span.style.left='+adpop_span.style.left+', adpop_span.style.top='+adpop_span.style.top+', adpop_span.style.position='+adpop_span.style.position);
    ...
    if (validAdData(title, desc, domain, click) == 1)
    {
     ...
     setActiveClickThru(title, domain, click);
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function setActiveClickThru(title, domain, url)
 {
...
function stopSpinner(obj)
{
 ...
 function displayAdBox()
 {
  ...
  sendDisplayMessage('domain='+properties.page_domain+' afid='+config.afid+':'+config.subid+' uip='+properties.userip+'; intdisthits='+properties.intdisthits+'; q=['+properties.adbox_query_text+'] r=['+properties.page_url+'] b=['+browser+']');
